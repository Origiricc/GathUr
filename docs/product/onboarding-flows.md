...
| Step                                                   | Status | Notes                                                                                                                                                                                                         |
| ------------------------------------------------------ | ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Find your church                                    | ✅     | `/onboarding` — search, join, or create ("Can't find your church?")                                                                                                                                           |
...
| Step                                                          | Status | Notes                                                                                                                                                                 |
| ------------------------------------------------------------- | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1. Create church account                                      | ✅     | Platform admins create churches at `/platform` (name, location, website, primary-admin email → auto-invitation); members can also self-serve create via `/onboarding` |
